      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
          ...
          <Link href="/" onClick={onClose} className="flex items-center gap-2">
            <img src={logoUrl} alt={config.siteName} className="size-8 rounded-full object-cover ring-1 ring-violet-500/50" />
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-3 space-y-1">
          ...
          <div className="mx-1 flex items-center justify-between px-4 py-3 rounded-xl bg-white/5 border border-white/10 mt-2">
            ...
            >
              <span className={`absolute top-0.5 size-5 rounded-full bg-white shadow transition-transform duration-300 ${darkMode ? "-translate-x-5" : "translate-x-0.5"}`} />
            </button>
