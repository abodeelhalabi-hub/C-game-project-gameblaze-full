...
import logoUrl from "@assets/ChatGPT_Image_1_May_2026_18_02_15_1777725145572.png";
    ...
    <div className="min-h-screen relative flex items-center justify-center">
      ...
      <div className="relative w-full max-w-sm mx-auto px-4">
        <div className="neon-border rounded-3xl p-8 text-center">
          ...
          <img src={logoUrl} alt={config.siteName} className="size-14 rounded-full object-cover mx-auto mb-3 ring-2 ring-white/20" />
...
export default function Admin() {
  ...
  useEffect(() => {
    if (!sessionStorage.getItem(SESSION_KEY)) setAuthed(false);
  }, []);
  ...
  async function uploadFileChunked(
    ...
    const base = `${import.meta.env.BASE_URL}api/games/chunk`.replace(/\/+/g, "/");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-3 group min-w-0">
            <div className="relative shrink-0">
              ...
              <img src={logoUrl} alt={config.siteName} className="relative size-12 rounded-full object-cover ring-2 ring-white/20" />
            </div>
