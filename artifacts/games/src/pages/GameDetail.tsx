          ...
          <Link href="/" className="flex items-center gap-3 min-w-0 group">
            <div className="relative shrink-0">
              ...
              <img
                src={logoUrl}
                alt={config.siteName}
                className="relative size-10 rounded-full object-cover ring-2 ring-white/20"
              />
            </div>
          ...
          <section className="relative">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-8 pb-10">
              ...
              <div className="grid lg:grid-cols-[260px_1fr] gap-6 lg:gap-10 items-start">
                <div className="aspect-[3/4] w-full max-w-[220px] sm:max-w-[260px] mx-auto lg:mx-0 rounded-2xl overflow-hidden ring-1 ring-white/10 shadow-2xl shadow-violet-900/40 bg-gradient-to-br from-violet-600/30 to-fuchsia-600/30">
                  {game.cover ? (
                    <img
                      src={gameCoverUrl(game.id)}
                      alt={game.name}
                ...
                <div className="neon-border rounded-2xl p-5 relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <span className="relative">{downloading ? "جارٍ التنزيل..." : "تنزيل برابط مباشر"}</span>
                    </button>
                    {downloadError && (
